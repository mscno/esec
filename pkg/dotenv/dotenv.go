...
// Formatter implements format.Handler for .env (dotenv) files.
...
func (d *Formatter) ExtractPublicKey(data []byte) ([32]byte, error) {
...
func (d *Formatter) TransformScalarValues(data []byte, fn func([]byte) ([]byte, error)) ([]byte, error) {
